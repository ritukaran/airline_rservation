...
<sql:param value="${param.AirlineId}" />
<sql:param value="${param.AirlineName}" />
<sql:param value="${param.FromLocation}" />
<sql:param value="${param.ToLocation}" />
<sql:param value="${param.Departure}" />
<sql:param value="${param.Arrival}" />
